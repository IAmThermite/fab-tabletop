...
**PubSub.** Two topics: `"tournaments"` (`{:tournaments_updated}`, list-level) and `"tournament:<id>"` (`{:tournament_updated, id}`, anything attached to one tournament). Context writers broadcast; LiveViews subscribe and reload.
